    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, null=True, upload_to='cards_image', verbose_name='Изображение')),
                ...
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='cards.categories', verbose_name='Категория')),
            ],
            options={
